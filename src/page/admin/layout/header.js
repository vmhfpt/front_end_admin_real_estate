...
import {actionLogout} from "../../../state/admin/auth/actionLogin";
import  {logout} from "../../../api/admin/auth/authReducer";
function Header(){
    ...
    <nav className="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul className="navbar-nav">
        ...
        <li className="nav-item d-none d-sm-inline-block">
         ...
         onClick={LogOut}
          to="#" 
          className="nav-link">Đăng xuất</Link>
        </li>
      </ul>
      ...
      <ul className="navbar-nav ml-auto">
        ...
        <li className="nav-item">
          <Link className="nav-link" data-widget="control-sidebar"  to="#" role="button">
