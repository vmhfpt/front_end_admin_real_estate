  ...
  // console.log('dataEdit',dataEdit.library)
    return (<div className="container custom_top">
        <div className=" card card-warning">
          <div className="card-header">
            <h3 className="card-title">Sửa bài viết "{dataEdit.title}"</h3>
    ...
    <strong>Lỗi!</strong> {error.content}.
        ...
        {isLoad &&  <div className="overlay-wrapper">
            <div className="overlay"><i className="fas fa-3x fa-sync-alt fa-spin"></i><div className="text-bold pt-2">Đang cập nhật...</div></div>
      </div>}
      </div>)
}
