...
import {update} from "./projectReducer";
import {getLoad} from "./selectProject";
function EditProject({setTab, dataEdit}){
  ...
  const [active, setActive] = useState(1);
   ...
   const [groundThird, setGroundThird] = useState({
    ...
    investor_content : dataEdit.investor,
    position_content : dataEdit.position,
    utility_content : dataEdit.utility,
    ground_floor : dataEdit.ground_floor,
    price : dataEdit.price,
    pay_method : dataEdit.pay_method,
    progress : dataEdit.progress,
    example_house : dataEdit.example_house,
    faq : dataEdit.faq,
   })
   ...
   useEffect(() => {
    setGroundFirst({
        ...
        block_number : dataEdit.block_number,
        apartment_number : dataEdit.apartment_number,
        floor_number : dataEdit.floor_number,
        price_rent : dataEdit.price_rent,
        price_sale_title : dataEdit.price_sale,
     });

     setGroundSecond({
        position : dataEdit.project_value_id.position,
        name_commerce : dataEdit.project_value_id.name_commerce,
        investor : dataEdit.project_value_id.investor,
        contractor_sum : dataEdit.project_value_id.contractor_sum,
        distribution_unit : dataEdit.project_value_id.distribution_unit,
        design : dataEdit.project_value_id.design,
        scale : dataEdit.project_value_id.scale,
        area_sum : dataEdit.project_value_id.area_sum,
        apartment_type : dataEdit.project_value_id.apartment_type,
        area_type : dataEdit.project_value_id.area_type,
        utility : dataEdit.project_value_id.utility,
        start_up : dataEdit.project_value_id.start_up,
        law : dataEdit.project_value_id.law,
        price_sale : dataEdit.project_value_id.price_sale,
       });
 ...
 const handleSubmit = () => {
    ...
    var  objectPayLoad = {...groundFirst, ...groundSecond, ...groundThird,  ...{address : address}, active, ...{slug : dataEdit.slug}};
    var payLoad = {file, data :  objectPayLoad};
    //console.log(payLoad);
    dispatch(update(payLoad));
    setSuccess('Sửa thành công dự án' + groundFirst.name);
    ...
    <div className="card card-warning">
      <div className="card-header">
        <h3 className="card-title">Sửa dự án "{dataEdit.name}"</h3>
    ...
    {isLoad &&  <div className="overlay-wrapper">
          <div className="overlay"><i className="fas fa-3x fa-sync-alt fa-spin"></i><div className="text-bold pt-2">Đang lưu...</div></div>
    </div>}
  </div>)
}
